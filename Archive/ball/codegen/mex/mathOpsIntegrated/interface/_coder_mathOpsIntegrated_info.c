 ...
 *
 * Code generation for function '_coder_mathOpsIntegrated_info'
 *
 */

/* Include files */
#include "_coder_mathOpsIntegrated_info.h"
#include "emlrt.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", emlrtMxCreateString("mathOpsIntegrated"));
  emlrtSetField(xEntryPoints, 0, "NumberOfInputs", emlrtMxCreateDoubleScalar(2.0));
  emlrtSetField(xEntryPoints, 0, "NumberOfOutputs", emlrtMxCreateDoubleScalar
                (2.0));
  emlrtSetField(xEntryPoints, 0, "ConstantInputs", xInputs);
  emlrtSetField(xEntryPoints, 0, "FullPath", emlrtMxCreateString(
    "/home/kieran/Documents/MATLAB/MPC/Archive/ball/mathOpsIntegrated.m"));
...
/* End of code generation (_coder_mathOpsIntegrated_info.c) */
