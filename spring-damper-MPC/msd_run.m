...
% ----------------------------------------------------------------------- %
functions.dynamics          = @msd_dynamics;
functions.output            = @msd_output;
...
control_model.auxdata.c     = 1;
control_model.auxdata.k     = 5;
control_model.dynamics      = @msd_dynamics;
control_model.output        = @msd_output;
...
input.reference_function    = @msd_ref;
